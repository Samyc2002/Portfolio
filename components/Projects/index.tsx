...
import { CodersGarage, CodeforcesLeaderboard, VideoCalls, ReactIDE } from '../ProjectCards/ProjectCards';
    ...
    return (
        <>
            <Typography gutterBottom variant="h4" align="center">
                My Recent <span style={{ color: colors.red, fontWeight: 600 }}>Tech Projects</span>
            </Typography>
