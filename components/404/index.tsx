  ...
  React.useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      indices.forEach((index) =>
        setPages((prevPages) => [...prevPages, keys[index as number]])
      );
    }
    setLoading(false);
  }, [state]);
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12}>
            <Typography variant="h4" align="center" gutterBottom>
              You seem...{' '}
              <span style={{ color: colors.red, fontWeight: 600 }}>lost</span>?
            </Typography>
            <Typography variant="h6" align="center">
              ...
              <span
                style={styles}
                onClick={() =>
                  router.push('https://github.com/Samyc2002/Portfolio')
                }
            ...
            <Typography variant="h6" align="center">
              ...and while you&apos;re here, why don&apos;t you check out the
              following page(s)?
              <br />
              {pages.map((page) => (
                <>
