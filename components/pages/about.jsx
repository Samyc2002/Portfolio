            ...
            <div className="flex flex-col gap-4">
                ...
                <span>
                    ...
                    <p style={{ color: "#828282", fontSize: "22px" }}>
                        I am also a <span style={{ color: "hsl(var(--foreground))" }}>Technical content writer</span> and write about things I learn on <a href="https://medium.com/@Samyc2002" style={{ color: "#09CFDB", textDecoration: "none" }}>Medium</a>.
                    </p>
                </span>
            </div>
        </div>
